...
| `generated`, `generator.sha256` | when (UTC, `"YYYY-MM-DD"`, quoted), and by which exact generator script | the script's own sha256 so a generator change is visible |
